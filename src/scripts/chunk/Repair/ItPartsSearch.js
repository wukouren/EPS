...
class ItPartsSearch extends Component {
 ...
 // *  	
 // *  }
 		let ownerInfo = getDict('itPartsOwnerInfo');
		...
		return (
			<div className="eps-parts-search">
				...
				<div className="eps-search-body">
					<ObjectSelectList data={ data } searchType="itparts"  onAdd={ this.onAdd } ownerInfo={ ownerInfo }/>
				</div>
			</div>
		);
	}
