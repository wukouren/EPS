...
var ScrappedSearch = function (_Component) {
  _inherits(ScrappedSearch, _Component);

  function ScrappedSearch(props) {
    _classCallCheck(this, ScrappedSearch);

    var store = new Store('Joywok:cache:tabs:selectScrapped');
    var cache = store.find({ id: 'tab:cache' }) || {};
    if (cache['id']) {
      props['objectselect']['parentData'] = cache["data"]["parentData"];
    }
    return _possibleConstructorReturn(this, (ScrappedSearch.__proto__ || Object.getPrototypeOf(ScrappedSearch)).call(this, props));
  }

  _createClass(ScrappedSearch, [{
    key: 'onAdd',
    ...
    value: function componentDidMount() {
      ...
      PubSub.subscribe('select:scrapped', function (evt, data) {
        ...
        var datas = self.props.objectselect;
