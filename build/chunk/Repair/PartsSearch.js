...
var PartsSearch = function (_Component) {
	_inherits(PartsSearch, _Component);

	function PartsSearch(props) {
		_classCallCheck(this, PartsSearch);

		return _possibleConstructorReturn(this, (PartsSearch.__proto__ || Object.getPrototypeOf(PartsSearch)).call(this, props));
	}

	_createClass(PartsSearch, [{
		key: 'onAdd',
