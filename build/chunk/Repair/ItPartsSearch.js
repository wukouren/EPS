...
var ItPartsSearch = function (_Component) {
	_inherits(ItPartsSearch, _Component);

	function ItPartsSearch(props) {
		_classCallCheck(this, ItPartsSearch);

		return _possibleConstructorReturn(this, (ItPartsSearch.__proto__ || Object.getPrototypeOf(ItPartsSearch)).call(this, props));
	}

	_createClass(ItPartsSearch, [{
		key: 'onAdd',
		value: function onAdd(objects) {
			console.log('IT parts search:', objects);
		}
