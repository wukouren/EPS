...
var DeviceSearch = function (_Component) {
	_inherits(DeviceSearch, _Component);

	function DeviceSearch(props) {
		_classCallCheck(this, DeviceSearch);

		return _possibleConstructorReturn(this, (DeviceSearch.__proto__ || Object.getPrototypeOf(DeviceSearch)).call(this, props));
	}

	_createClass(DeviceSearch, [{
		key: 'onAdd',
		value: function onAdd(objects) {
			console.log('device search:', objects);
		}
