...
var SupplierResponseProject = function (_Component) {
	_inherits(SupplierResponseProject, _Component);

	function SupplierResponseProject(props) {
		_classCallCheck(this, SupplierResponseProject);

		var _this = _possibleConstructorReturn(this, (SupplierResponseProject.__proto__ || Object.getPrototypeOf(SupplierResponseProject)).call(this, props));

		_this.openLog = _this.openLog.bind(_this);
		return _this;
	}

	_createClass(SupplierResponseProject, [{
		key: 'render',
		value: function render() {
			var _this2 = this;
			...
			var btn = void 0;
			var data = this.props.supplierresponse;
			...
			if (data['loading']['loading']) {
				...
				if (isUnfinishedOrHistory()) {
					btn = _react2.default.createElement('div', { className: 'todo-info-status', onClick: function onClick(e) {
						...
						} }, _react2.default.createElement('i', { className: 'icon-time-b' }), _react2.default.createElement('div', { className: 'todo-status-c' }, _react2.default.createElement('span', { className: 'todo-status-title' }, _constants.orderStatus['repair'][data['orderState']]["label"]), _react2.default.createElement('span', { className: 'todo-status-tip' }, _constants.orderStatus['repair'][data['orderState']]["val"])));
				} else {
					btn = _react2.default.createElement('div', { className: 'todo-info-status' }, _react2.default.createElement('div', { className: 'eps-btn eps-btn-warning-large', onClick: function onClick(e) {
    	...
    	btn = (<div className="todo-info-status" onClick={(e)=>this.openProcessTable()}><i className="icon-time-b"></i><div className="todo-status-c"><span className="todo-status-title">{orderStatus['repair'][data['orderState']]["label"]}</span><span className="todo-status-tip">{orderStatus['repair'][data['orderState']]["val"]}</span></div></div>);
			...
			return _react2.default.createElement('div', { className: 'eps-repair-supplier-response' }, _react2.default.createElement('header', { className: 'header header-with-memo', ref: 'header' }, _react2.default.createElement('div', { className: 'header-bg' }), _react2.default.createElement('div', { className: 'header-bg-2' }), _react2.default.createElement('div', { className: 'header-c' }, _react2.default.createElement(_UserCard2.default, { data: _.extend(data, {
					name: data['createBy'],
					avatar: data['avatar'],
					time: data['dateAppointment'],
					fileCount: data['fileCount'] || 0,
					uploadPhaseName: data['uploadPhaseName'] || ''
				}) }))), content, _react2.default.createElement(_LoadMore2.default, { container: 'main-c', data: data['loading'] }), _react2.default.createElement('footer', { className: 'footer' }, _react2.default.createElement('div', { className: 'log-btn', onClick: this.openLog }, _react2.default.createElement('i', { className: 'icon-log' }), _react2.default.createElement('span', null, "\u6D41\u7A0B\u65E5\u5FD7")), btn));
		}
		// 组件加载完毕
		...
		value: function componentDidMount() {
			...
			(0, _EpsRequest2.default)('/McdEpsApi/joywok/repair/getCOOrderInfo', {
				method: 'POST',
				body: JSON.stringify({
					param: {
						condition: {
				...
				if (resp['data']['success'] == false) {} else {
					NProgress.done();
					var data = _.map(resp['data']['body']['orderList'], function (i) {
					...
					(0, _constants.getUsers)(resp['data']['body']['storeMan'], 'num', function (resp) {
			...
			window.onJwNavBtnClick = function (data) {
				if (data['type'] == '4') {
					var modelData = self.props.supplierresponse;
					(0, _constants.openChart)(modelData['storeMan'], modelData['orderNumber'], '供应商评估');
				}
			};
		}
	}, {
		...
		value: function combineContent() {
			var data = this.props.supplierresponse;
			var list = this.props.supplierresponse["list"];
			if (list && list.length > 0) {
				return _react2.default.createElement('div', { className: 'eps-repair-supr-content' }, _react2.default.createElement('ul', { className: 'eps-list-card-wrap eps-device-list' }, _.map(list, function (item) {
					return _react2.default.createElement(_ProjectCard.ProjectCardListShow, { itemdata: item });
				})));
			} else {
	...
	return SupplierResponseProject;
}(_react.Component);
...
exports.default = (0, _dva.connect)(mapStateToProps)(SupplierResponseProject);
