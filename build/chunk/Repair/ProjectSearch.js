...
var ProjectSearch = function (_Component) {
	...
	_createClass(ProjectSearch, [{
		...
		value: function render() {
			...
			// *  }
			var data = this.props.objectselect;
			return _react2.default.createElement('div', { className: 'root-container eps-projects-search' }, _react2.default.createElement('div', { className: 'root-container-w' }, _react2.default.createElement('header', { className: 'header clear-margin specail', ref: 'header' }, _react2.default.createElement('div', { className: 'header-bg' }), _react2.default.createElement('div', { className: 'header-bg-2' }), _react2.default.createElement('div', { className: 'header-c' })), _react2.default.createElement('sesstion', { className: 'main' }, _react2.default.createElement('div', { className: 'main-c', ref: 'listC', style: {
					height: data['containerHeight'] || 'auto',
					padding: 0,
					overflowY: 'visible'
				} }, _react2.default.createElement('div', { className: 'main-w eps-search-body' }, _react2.default.createElement(_ObjectSelectList2.default, { data: data, searchType: 'project', emptyIcon: 'icon-search-project-tip', onAdd: this.onAdd }))))));
		}
	}, {
		key: 'componentDidMount',
		value: function componentDidMount() {
