...
var StoreSearch = function (_Component) {
	_inherits(StoreSearch, _Component);

	function StoreSearch(props) {
		_classCallCheck(this, StoreSearch);

		return _possibleConstructorReturn(this, (StoreSearch.__proto__ || Object.getPrototypeOf(StoreSearch)).call(this, props));
	}
