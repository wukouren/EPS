...
var ItSearch = function (_Component) {
	_inherits(ItSearch, _Component);

	function ItSearch(props) {
		_classCallCheck(this, ItSearch);

		return _possibleConstructorReturn(this, (ItSearch.__proto__ || Object.getPrototypeOf(ItSearch)).call(this, props));
	}

	_createClass(ItSearch, [{
		key: 'onAdd',
