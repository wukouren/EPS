...
var PMStoreList = function (_Component) {
	...
	_createClass(PMStoreList, [{
		...
		value: function render() {
			...
			var viewIt = this._init_viewIt();
			var viewText = void 0;
			var type = this.props.params.vendorType;
			if (type == 1 || type == 2) {
				viewText = view;
			} else {
				viewText = viewIt;
			...
			if (data.loading['loading']) {
				...
				return _react2.default.createElement('div', { className: 'root-container' }, viewText);
			}
		}
	}, {
		key: 'NameInfo',
			...
			if (data.list == 'firstenter') {} else if (data.list && typeof data.list != 'string' && data.list.length > 0) {
				...
				listView = _react2.default.createElement('ul', { className: '' }, data.list.map(function (item, key) {
					return _react2.default.createElement('div', { className: "eps-list-card eps-project animated zoomIn eps-bookmark-wrap", onClick: function onClick() {
							...
							e.stopPropagation();self.NameInfo(item.provinceNameCn + '' + item.cityNameCn);
						} }, item.provinceNameCn + '' + item.cityNameCn)))), !data.isTsi && _react2.default.createElement('div', { className: 'eps-item-info-inline' }, _react2.default.createElement('div', { className: 'eps-item-info' }, _react2.default.createElement('dt', null, _react2.default.createElement('label', null, "\u603B\u4EF7(\xA5)")), _react2.default.createElement('dd', null, _react2.default.createElement('font', { onClick: function onClick(e) {
							e.stopPropagation();self.NameInfo(self.turnMoney(item.priceall) + ' ¥');
						} }, _this3.turnMoney(item.priceall), ' \xA5')))), data.isTsi && _react2.default.createElement('div', { className: 'project-it-text border-line-h before' }, _react2.default.createElement('div', { className: 'project-it-cell space-b' }, _react2.default.createElement('div', { className: 'project-it-flex w60' }, "\u9EA6\u5F53\u52B3\u91C7\u8D2D\u603B\u4EF7(\u542B\u7A0E)"), _react2.default.createElement('div', { className: 'project-it-flex', onClick: function onClick(e) {
							e.stopPropagation();self.NameInfo(self.turnMoney(item.mdcSumCost) + ' ¥');
							...
							e.stopPropagation();self.NameInfo(self.turnMoney(item.tsiSumCost) + ' ¥');
							...
							e.stopPropagation();self.NameInfo(self.turnMoney(item.eqPriceAll) + ' ¥');
							...
							e.stopPropagation();self.NameInfo(self.turnMoney(item.labourCost) + ' ¥');
							...
							e.stopPropagation();self.NameInfo(self.turnMoney(item.travelExpensesNotax) + ' ¥');
							...
							e.stopPropagation();self.NameInfo(self.turnMoney(item.travelExpenses) + ' ¥');
							...
							e.stopPropagation();self.NameInfo(self.turnMoney(item.special) + ' ¥');
