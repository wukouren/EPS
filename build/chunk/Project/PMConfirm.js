...
var _HeaderCard = __webpack_require__(1948);

var _HeaderCard2 = _interopRequireDefault(_HeaderCard);

var _VendorCard = __webpack_require__(1951);
...
function _inherits(subClass, superClass) {
   ...
   *    路由：/project/pmconfirm/:orderid
   * 2. DOA审批（设备／工程／IT）拆单前的 
   *    路由：/project/approval/:orderid?type=1
   *
   * 项目采购需求：
...
var PMConfirm = function (_Component) {
  ...
  _createClass(PMConfirm, [{
    ...
    value: function rejectOrder(approveFlg, memo, callback) {
      ...
      // return;
      (0, _EpsRequest2.default)('/McdEpsApi/joywok/project/submitOrderInfo', {
        method: 'POST',
        body: JSON.stringify({
          param: {
    ...
    value: function componentDidMount() {
      ...
      //获取供应商列表
      (0, _EpsRequest2.default)('/McdEpsApi/joywok/project/getVendorInfo', {
        method: 'POST',
        body: JSON.stringify({
          param: {
            eid: eid,
      ...
      (0, _EpsRequest2.default)('/McdEpsApi/joywok/project/getOrderInfo', {
        method: 'POST',
        body: JSON.stringify({
          param: {
            eid: eid,
    ...
    value: function render() {
      ...
      var self = this;
      var data = this.props.pmconfirm;
      var isNotChecked = /view/.test(location.href); //在途和历史的拒绝备注右边的单选框不能选择
      console.log('rrr', data, isNotChecked);
      var objecttype = this.props.params.objecttype;
      // 组织显示内容
      if (data.loading) {
        ...
        var buttons = '',
            project = data,
            strOrderSta = project['orderState'] && _constants.orderStatus["project"]['41'][project['orderState']] ? _constants.orderStatus["project"]['41'][project['orderState']] : { 'label': '' };
